       ...
       <div>
         ...
         <div>
           ...
           <img src={pass} alt="pass" className="su-email"/>
             <input type="text" placeholder="Firstname" className="su-name"/>
           </div>
          
           <div style={{paddingTop:"20px"}}>
             <img src={email} alt="email" className="su-email"/>
             <input type="text" placeholder="user name or email" className="su-name"/>
           </div>
          

           <div className="su-second-input">
             <img src={pass} alt="pass" className="su-email"/>
             <input type="password" placeholder="user name" className="su-name"/>
           </div>
